...
If Odoo still needs your **API Credentials** to connect with your Stripe account, these are the
...
If Odoo still needs your **Webhook Signing Secret** to connect with your Stripe account, you can
create a webhook either automatically or manually.

.. tabs::
   .. group-tab:: Create the webhook automatically
   ...
   .. group-tab:: Create the webhook manually
